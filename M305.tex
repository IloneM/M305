...
\begin{rem}
Tout groupe ab\'elien $(G,+,e_G)$ peut s'identifier \`a un $\Z$-module en posant:\\
$\app{\cdot}{\Z\times G}{G}{(n,g)}{\begin{cases}e_G & si\, n=0\\\sum_{i=1}^n g & si\, n>0\\\sum_{i=1}^{-n} (-g) & si\, n<0\end{cases}}$. On v\'erifie ais\'ement que
$\cdot$ v\'erifie:\\
